...
:   Improved speed through the use of [webfontloader](https://github.com/typekit/webfontloader). Reduced Open+Sans font and only embedded normal weight. Now fonts load asynchronous and the package is 53kb lighter.
